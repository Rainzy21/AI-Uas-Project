  ...
  const steps = [
    {
      ...
      title: "Upload Gambar",
      description: "Upload screenshot, mockup, atau foto design apapun — PNG, JPG, WebP hingga 4 MB.",
    ...
    },
    {
      ...
      title: "Kirim ke OpenRouter",
      description: "Gambar dikirim ke OpenRouter API bersama prompt terstruktur untuk analisis mendalam.",
      note: "Menggunakan model multimodal via OpenRouter dengan temperature 0.2 untuk output yang konsisten dan terstruktur.",
    },
    {
      id: "03",
      icon: <FileJson className="w-5 h-5 text-gray-400" />,
      title: "Ekstraksi JSON",
      description: "AI mengurai komponen UI, hierarki layout, palet warna, tipografi, dan gaya desain ke dalam JSON.",
    ...
    },
    {
      ...
      description: "Dari analisis tersebut, AI menghasilkan kode HTML lengkap dengan Tailwind CDN yang mereproduksi desain.",
